<template>
    ...
    class="meter-list"
    >
        <f7-navbar title="任务列表" back-link=""></f7-navbar>
        <f7-toolbar tabbar bottom>
            <f7-link tab-link="#tab-1" tab-link-active @click="state = 'unread'">未抄表</f7-link>
            <f7-link tab-link="#tab-2" @click="state = 'unconfirmed'">未确认</f7-link>
            <f7-link tab-link="#tab-3" @click="state = 'submitted'">已抄表</f7-link>
        </f7-toolbar>
        <f7-tabs class="meter-tab" animated>
            <f7-tab class="page-content" id="tab-1" tab-active>
               <f7-block>
                    <f7-list
                    media-list
                    v-for="(month, key) in Object.keys(unreadListData)"
                    :key='key'
                    class="list-content"
                    >
                        ...
                        <f7-list-item
                            ...
                            v-for="(item, index) in unreadListData[month]"
                            :key='index'
                            link="#"
            ...
            <f7-tab class="page-content" id="tab-2">
               <f7-block>
                    <f7-list
                    media-list
                    v-for="(month, key) in Object.keys(unconfirmedListData)"
                    :key='key'
                    class="list-content"
                    >
                        <f7-block-title>{{month}}</f7-block-title>
                        <f7-list-item
                            @click="turnToDetailMeterPage(item)"
                            v-for="(item, index) in unconfirmedListData[month]"
                            :key='index'
                            link="#"
                            :title="item.customer_name"
                            :after="item.date_group"
            ...
            <f7-tab class="page-content" id="tab-3">
                <f7-block>
                    <f7-list
                    media-list
