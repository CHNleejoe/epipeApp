...
function customConfirmDialog(component, text, title, buttons, callbacks, type, force, listContent) {
    ...
    if (type === 'preloader') {
        console.log(component.$u.getPlatformType())
        if (component.$u.getPlatformType() != 'ios') {
            ...
            confirm.content = '<div class="preloader color-orange"><span class="preloader-inner"><span class="preloader-inner-line"></span><span class="preloader-inner-line"></span><span class="preloader-inner-line"></span><span class="preloader-inner-line"></span><span class="preloader-inner-line"></span><span class="preloader-inner-line"></span><span class="preloader-inner-line"></span><span class="preloader-inner-line"></span><span class="preloader-inner-line"></span><span class="preloader-inner-line"></span><span class="preloader-inner-line"></span><span class="preloader-inner-line"></span></span></div>'
        }
