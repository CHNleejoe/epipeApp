var cordovaApp = {
  ...
  */
  ...
  fixKeyBorardCovered: function () {
    // 监听键盘显示
    window.addEventListener('native.keyboardshow', function (e) {
      // alert(document.activeElement)
      // alert('键盘高度:' + e.keyboardHeight)
      document.documentElement.style.height = document.documentElement.clientHeight - e.keyboardHeight + 'px'
      // }
    })
    // 监听键盘隐藏  
  ...
  init: function (f7) {
    ...
    if (cordova.platformId == 'android') {
      cordovaApp.fixKeyBorardCovered();;
    }
  },
};
